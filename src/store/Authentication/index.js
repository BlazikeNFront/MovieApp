export default {
  ...
  actions: {
    ...
    async signIn(context, payload) {
      try {
        ...
        const userNameData = await fetch(
          `https://movieapp-9f058-default-rtdb.firebaseio.com/${context.state.userId}/userName.json`
        );
    ...
    async setUserName(context, payload) {
      ...
      const response = await fetch(
        `https://movieapp-9f058-default-rtdb.firebaseio.com/${payload.userID}/userName.json`,
        {
          method: "PUT",
          body: userName,
        }
